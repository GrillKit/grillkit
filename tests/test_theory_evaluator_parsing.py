...
"""Tests for theory evaluator JSON parsing helpers."""
...
def test_parse_json_response_rejects_empty_content() -> None:
    """Parsing raises a clear error when the model returns an empty body."""
    with pytest.raises(ValueError, match="invalid JSON"):
        parse_json_response("", InterviewEvaluation)
