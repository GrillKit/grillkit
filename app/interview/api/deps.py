...
def get_session_creation_service() -> type[SessionCreationService]:
    """Return the session creation service class used by API handlers."""
    return SessionCreationService


def get_session_completion_service() -> type[SessionCompletionService]:
    """Return the session completion service class used by API handlers."""
