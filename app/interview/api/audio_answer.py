...
"""HTTP audio-answer transport adapter for interview sessions."""
...
from app.interview.api.ws_protocol import domain_error_to_wire, event_to_message
...
class InterviewAudioAnswerAdapter:
