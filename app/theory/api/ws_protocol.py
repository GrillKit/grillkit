...
"""WebSocket and NDJSON wire protocol mapping for theory sessions."""
...
def server_message_from_event(
    ...
    Args:
        event: Event from theory submission or session completion services.
...
def event_to_message(event: InterviewEvent) -> dict[str, Any]:
    """Convert a semantic service event to a WebSocket JSON message.
